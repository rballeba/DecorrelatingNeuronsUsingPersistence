...
experiment_templates_to_execute = [
    ...
    {'json_template': 'experiments/MNIST/specifications/public_data_template_task1_std_avg.json',
    ...
    {'json_template': 'experiments/MNIST/specifications/public_data_template_task1_imp.json',
     'possible_topo_weights': [0.000001, 0.00001, 0.0001, 0.001, 0.01, 0.1, 1, 5, 10, 100]},
    {'json_template': 'experiments/MNIST/specifications/public_data_template_task1_l1_reg.json',
     'possible_topo_weights': [0.000001, 0.00001, 0.0001, 0.001, 0.01, 0.1, 1, 5, 10, 100]},
    {'json_template': 'experiments/MNIST/specifications/public_data_template_task1_l2_reg.json',
     'possible_topo_weights': [0.000001, 0.00001, 0.0001, 0.001, 0.01, 0.1, 1, 5, 10, 100]},
    {'json_template': 'experiments/MNIST/specifications/public_data_template_task1_min_corr.json',
     'possible_topo_weights': [0.000001, 0.00001, 0.0001, 0.001, 0.01, 0.1, 1, 5, 10, 100]}
]
...
def worker_execution(task):
    gpu = queue.get()
    try:
        # Execute mnist_server_individual_execution.py in a new process
        os.system(f'python3 mnist_server_individual_execution.py {gpu} {task[0]} {task[1]}')
